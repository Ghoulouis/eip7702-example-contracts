...
const IMPLEMENTATION_ADDRESS = "0x8Aa00fF8a8c4F383e3e1D4809da51e0e1443Fb13";
...
async function getData() {
  ...
  let depositTx = await vault.depositEip7702.populateTransaction("0x6E33FD6dD5aD776A218e3CB4ddaB6E8868f2eEfD", amount);
  ...
  let multicall = BatchExecutor__factory.connect("0x8Aa00fF8a8c4F383e3e1D4809da51e0e1443Fb13");

  let data2 = await multicall.deposit.populateTransaction(amount);
